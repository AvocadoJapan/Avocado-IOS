//
//  ProfileDetailHeaderReusableView.swift
//  Avocado
//
...
final class ProfileDetailHeaderReusableView: UICollectionReusableView {
    static var identifier = "ProfileDetailHeaderReusableView"
    // 전체 화면을 담을 스택 뷰
...
import SwiftUI
import RxSwift
struct ProfileDetailHeaderReusableViewPreview: PreviewProvider {
    static var previews: some View {
        return ProfileDetailHeaderReusableView().toPreview().previewLayout(.fixed(width: 375, height: 700))
    }
}
#endif
