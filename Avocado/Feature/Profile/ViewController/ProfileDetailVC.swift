...
final class ProfileDetailVC: BaseVC {
    ...
    private lazy var collectionView = UICollectionView(
        ...
        $0.register(
            ProfileDetailHeaderReusableView.self,
            forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader,
            withReuseIdentifier: ProfileDetailHeaderReusableView.identifier
        )
        ...
        let dataSource = RxCollectionViewSectionedReloadDataSource<UserProfileDataSection> { dataSource, collectionView, indexPath, item in
            ...
            if (kind == UICollectionView.elementKindSectionHeader) {
                let headerView = collectionView.dequeueReusableSupplementaryView(
                    ...
                    withReuseIdentifier: ProfileDetailHeaderReusableView.identifier,
                    for: indexPath
                ) as! ProfileDetailHeaderReusableView
...
extension ProfileDetailVC: CollectionViewLayoutable {
...
import SwiftUI
import RxSwift
struct ProfileDetailVCPreview: PreviewProvider {
    static var previews: some View {
        return UINavigationController(
            rootViewController: ProfileDetailVC(
